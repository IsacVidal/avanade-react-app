...
function Header(props){
    ...
    // getter & setter
    // Hooks - useAlgumaCoisa, useState, useEffect, useRef, useContext
    ...
    //executar a primeira vez que a página for carregada(Google). E cada vez que um estado for alterado (Avanade). Ele executa novamente.
    useEffect(() => {
